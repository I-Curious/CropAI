...
def add_confirm(request):
    if request.method == 'POST':  
        ...
        print(data_market)
        for i in range(len(views.data_market)): 
                if views.data_market[i]['Crop'] == fname:
                        print('here')
                        print(views.data_market[i]['market_trend'])
                        views.data_market[i]['market_trend']=views.data_market[i]['market_trend']+2
                        print(views.data_market[i]['market_trend'])
